...
- `src/lib` — form data types, the US state list, and the case-type-to-section-title mapping
...
- On mobile, the dropdown fields (case type, attorney, phone country code, mailing state, accident time) use a custom-built dropdown instead of the phone's native one, since iOS Safari can render native dropdowns in the wrong position. Desktop and tablet still use the native dropdown.
